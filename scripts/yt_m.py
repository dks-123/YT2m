...
def grab(youtube_url):
    ...
    yt_dlp_cmd = f"yt-dlp --buffer-size 16M --throttled-rate 5M --geo-bypass --cookies cookies.txt --sleep-requests 1 --limit-rate 500k --retries 5 --fragment-retries 5 --no-warnings --quiet --no-check-certificate --no-playlist {youtube_url}"
    try:
