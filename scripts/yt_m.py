...
def grab(youtube_url):
    ...
    yt_dlp_cmd =‘yt-dlp -f "bestaudio[protocol=m3u8]+bestvideo[protocol=m3u8]" --geo-bypass --cookies cookies.txt --sleep-requests 1 --limit-rate 1M --retries 5 --fragment-retries 10 --no-warnings --quiet --no-check-certificate --no-playlist {youtube_url}’
    try:
